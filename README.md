...
[![GitHub Release](https://img.shields.io/badge/release-3.1.05-blue)](https://github.com/rvwoens/centos-laravel-stack)
...
```bash
yum -y install tar
curl -s -L https://github.com/rvwoens/centos-laravel-stack/archive/v3.1.05.tar.gz | tar -xz
cd centos-laravel-stack-3.1.05
./setup_full
```
